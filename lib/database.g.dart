...
class $CandlesTable extends Candles with TableInfo<$CandlesTable, Candle> {
  ...
  static const VerificationMeta _adjCloseMeta = const VerificationMeta(
    'adjClose',
  );
  @override
...
class $TradesTable extends Trades with TableInfo<$TradesTable, Trade> {
  ...
  static const VerificationMeta _realizedPLMeta = const VerificationMeta(
    'realizedPL',
  );
  @override
...
abstract class _$Database extends GeneratedDatabase {
  ...
  late final Index idxCandlesSymbolDate = Index(
